...
def solve(
    ...
    a plasma is limited can improve convergence. This sets the number of iterations to wait+1.
    """
    ...
    while True:
        ...
        if(not wait_for_limited):
            ok_to_break = True
            # print('Not waiting for limited, ok to break')
            ...
            ok_to_break = False
            #print('Waiting for limited, not limited, NOT ok to break')
